function [bta] = NetCox(Data, lamda, alpha, d, S,SurTime)
% lambda & alpha is the para of the object function
% lambda & alpha is array
...
% bta: three dimensional matrix, and the third dimension is corrlated with
% gene & the first as well as second dimension is corrlated with lambda &
% alpha 
[~,index]=sort(SurTime);
Data=Data(index,:);
d  = d(index);
